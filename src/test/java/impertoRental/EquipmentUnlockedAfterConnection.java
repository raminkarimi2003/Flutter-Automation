...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case is to assert that equipment will be  automatically unlocked in drive after 
// connection
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class EquipmentUnlockedAfterConnection extends BaseIOSTest{
	private static Logger log=LogManager.getLogger(EquipmentUnlockedAfterConnection.class.getName()); // defining log4j manager for this class
	@Test(groups={"TestGroup3"})
	public void equipmentUnlockedAfterConnection_Reset() throws InterruptedException, IOException
	{		
		...
		if(!(drive.unlockedStatus.size()>0))
			 log.error("Equipment cannot be unlucked automatically");
		Thread.sleep(1000);
	    Assert.assertTrue(drive.unlockedStatus.size()>0);  // assert that asset is unlocked
