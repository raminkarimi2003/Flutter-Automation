...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case is to demonstrate that the user has the ability to push the app to background and re-launch the
// app.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class LeavingAndRelaunching extends BaseIOSTest{
 
	@Test(groups={"TestGroup4"})
	public void LeaveAndRelauch_Reset() throws InterruptedException, IOException
	{		
        ...
        StartRental.rent(driver,"Start Rental");  // rent
       	driver.runAppInBackground(Duration.ofSeconds(3)); // place the app in the background for 3 seconds
        Thread.sleep(1000);
