...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case is to demonstrate that user can start app, close it and launch it again and go 
// the renting process, pre-check and post-check and finish the process.
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class CloseAndLaunchApp extends BaseIOSTest{
 
	@Test(groups={"TestGroup2"})
	public void CloseAndLaunch_NoReset() throws InterruptedException, IOException
	{
        ...
        driver.launchApp();  // Launch the app  again from location it was left off
