...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test cases is to demonstrate that the app is capable of making extended rental
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class ExtendedRental extends BaseIOSTest{
 
	@Test(groups={"TestGroup3"})
	public void ExtendedRent_Reset() throws InterruptedException, IOException
	{		
		...
		int RentalPeriod=61;  // represent the day(s) including today
