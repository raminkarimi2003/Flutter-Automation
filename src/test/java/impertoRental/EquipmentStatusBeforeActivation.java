...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case with will verify the status of equipment before pre-check submission.(OHW-2770)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class EquipmentStatusBeforeActivation extends BaseIOSTest{
 
	@Test(groups={"TestGroup3"})
	public void statusBeforeActivation_Reset() throws InterruptedException, IOException
	{		
		...
		Assert.assertEquals(rented.preCheckStatus.getText(),"Check required");  // Assert that 'check required' is present 
		// on booking before pre-check
		Thread.sleep(2000);
		UseEquipment.use(driver, "Use Equipment");
