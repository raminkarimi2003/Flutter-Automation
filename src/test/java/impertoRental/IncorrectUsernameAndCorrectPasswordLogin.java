...
//with correct password with appropriate message.
///////////////////////////////////////////////////////////////////////////////////////////////////////////

public class IncorrectUsernameAndCorrectPasswordLogin extends BaseIOSTest{
 
	@Test(groups={"TestGroup4"})
	public void IncorrectUsernameAndCorrectPassword_Reset() throws InterruptedException, IOException
	{		
		...
		hl.Continue.click();
        new Login(driver);
        Login.App("WrongUserName",password);   // attempt to login with no User name and password
