...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//The purpose of this test case is to demonstrate operator has the ability to connect and disconnect the app to Drive
// and continue operation with the app.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class ConnectAndDisconnectOnDriveAsOperator extends BaseIOSTest{
 
	@Test(groups={"TestGroup2"})
	public void ReconnectonDriveAsOperator_NoReset() throws InterruptedException, IOException
	{		
        ...
        // disconnect from drive by navigating to Equipment page
        eq.Equipment.click(); // click on equipment icon
		eqd.useEquipment.click();
		Thread.sleep(3000);
