...
import utility.SimCardErrorDialog;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case is to demonstrate the the app will gracefully handle login with enabled 
// Airplane Mode and after turning on wiFi, The App continue its normal operation.
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class LoginAtemptWithEnabledAirplaneMode extends BaseIOSTest{
 
	@Test(groups={"TestGroup5"})
	public void AttemptloginWithEnabledAirplaneMode_NoReset() throws InterruptedException, IOException
	{		
