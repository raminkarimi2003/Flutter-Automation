...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class BookingAttemptWithNoWiFi extends BaseIOSTest{
 
	@Test(groups={"TestGroup2"})
	public void bookingAttemptWithNoWiFi_NoReset() throws InterruptedException, IOException
	{		
        ...
        driver.closeApp();
        driver.launchApp();
        ScrollToText.scroll("Start Rental");   // scroll to rental button again
		StartRental.rent(driver,"Start Rental");  // rent with Internet
