...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This test case will assert that the app can gracefully handle the BLE disruption during drive tab operation and can
// complete its renting process, after BLE restoration.
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class BLEDisruptionDuringDriveTab extends BaseIOSTest{
 
	@Test(groups={"TestGroup1"})
	public void BLEDisruptionDuringDriveTab_NoReset() throws InterruptedException, IOException
	{		
