...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// The purpose of this test case is to assert that the license plate  in the drive is the same as equipment ID
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class LicensePlateTest extends BaseIOSTest{
 
	@Test(groups={"TestGroup4"})
	public void LicensePlate_Reset() throws InterruptedException, IOException
	{
        ...
        Orientation.set(driver, "portrait");                 // set the orientation for photo to landscape
		...
		LicensePlate.Check(driver);  // assert the license plate in drive is the same as licensed plate as Equipment ID when booked
